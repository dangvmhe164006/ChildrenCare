<%-- 
    Document   : login
    Created on : May 20, 2024, 8:30:00 AM
    Author     : ACER
--%>
...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Login - ChildrenCare Booking System</title>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" value="${cookie.cu.value}" class="form-control" placeholder="Email" name="email" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="password" value="${cookie.cp.value}" name="pass" class="form-control" placeholder="Password" required="">
                                            </div>
                                        </div>
