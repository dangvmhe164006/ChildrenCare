<%-- 
    Document   : forgot
    Created on : May 23, 2024, 9:21:57 PM
    Author     : ACER
--%>
                    ...
                    <div class="col-lg-5 col-md-8">
                        ...
                        <div class="card login-page bg-white shadow mt-4 rounded border-0">
                            <div class="card-body">
                                ...
                                <form action="fogot" class="login-form mt-4"  method="post">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <p class="text-muted">Please enter your email address. You will receive a link to create a new password via email.</p>
                                            <div class="mb-3">
                                                <label class="form-label">Email address <span class="text-danger">*</span></label>
                                                <input type="email" class="form-control" placeholder="Enter Your Email Address" name="emailre" required="">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="d-grid">
