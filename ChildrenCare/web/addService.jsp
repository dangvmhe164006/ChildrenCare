            ...
            <div class="row">
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/AddServiceController" method="post">
                                <!-- Form Group (Service ID) -->
                                <div class="mb-3">
                                    <label class="small mb-1" for="serviceID">Service ID</label>
                                    <input class="form-control" id="serviceID" name="serviceID" type="text" placeholder="Enter service ID">
                                </div>
                                <!-- Form Group (Service Name)-->
                                <div class="mb-3">
                                    <label class="small mb-1" for="serviceName">Service Name</label>
                                    <input class="form-control" id="serviceName" name="serviceName" type="text" placeholder="Enter service name">
                                </div>
                                <!-- Form Group (Service Description)-->
                                <div class="mb-3">
                                    <label class="small mb-1" for="serviceDescription">Service Description</label>
                                    <input class="form-control" id="serviceDescription" name="serviceDescription" type="text" placeholder="Enter service description">
                                </div>
                                <!-- Form Group (Service Price)-->
                                <div class="mb-3">
                                    <label class="small mb-1" for="servicePrice">Service Price</label>
                                    <input class="form-control" id="servicePrice" name="servicePrice" type="text" placeholder="Enter service price">
                                </div>
                                <!-- Save changes button-->
