                ...
                <div class="blog_1r1i clearfix">
                    <div class="col-sm-4 space_left">
                        <div class="blog_1r1il clearfix">
                            <a href="blogDetail?ID=${p.postID}"><img src="${p.thumbnail}" class="iw" alt="abc"></a>
                        </div>
                    </div>
                    <div class="col-sm-8 space_left">
                        <div class="blog_1r1il clearfix">
                            <h6 class="col_2 mgt normal">${p.createdDate}</h6>
                            <h5><a class="col_1" href="blogDetail?ID=${p.postID}">${p.title}</a></h5>
                        </div>
                    </div>
                </div>
            </c:forEach>
